...
const todoSlice = createSlice({
  ...
  reducers: {
    ...
    editTodoText: (state, action: PayloadAction<{ id: number; newText: string }>) => {
...
export const { addTodo, toggleTodo, editTodoText, deleteCompleted, setFilter } = todoSlice.actions;
